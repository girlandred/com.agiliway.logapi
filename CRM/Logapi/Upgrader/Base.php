 ...
 */
class CRM_Logapi_Upgrader_Base {

  /**
   * @var CRM_Logapi_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Logapi_Upgrader(
        'com.agiliway.logapi',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Logapi_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Logapi_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
